$DownloadPath = Read-Host -Prompt "Enter A Download Path (without quotation marks)"
$FileName = Read-Host -Prompt "Filename (with .HTML)"
...
$Report | Out-File -FilePath $DownloadPath\$FileName
